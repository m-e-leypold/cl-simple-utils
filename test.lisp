...
(asdf:load-system "de.m-e-leypold.cl-simple-utils/tests")

;;; * Define sandbox for tests ------------------------------------------------------------------------------|

(defpackage :de.m-e-leypold.cl-simple-utils/run-tests
...
(in-package :de.m-e-leypold.cl-simple-utils/run-tests)
